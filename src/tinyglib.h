...
#    define FALSE (0)
#    define TRUE (1)
#    define GINT16_TO_BE(a) ((int16_t)__builtin_bswap16((uint16_t)a))
#    define GINT32_TO_BE(a) ((int32_t)__builtin_bswap32((uint32_t)a))
#    define GINT16_FROM_BE(a) ((int16_t)__builtin_bswap16((uint16_t)a))
#    define GINT32_FROM_BE(a) ((int32_t)__builtin_bswap32((uint32_t)a))
#    define GUINT16_TO_BE(a) ((uint16_t)__builtin_bswap16((uint16_t)a))
#    define GUINT32_TO_BE(a) ((uint32_t)__builtin_bswap32((uint32_t)a))
#    define GUINT16_FROM_BE(a) ((uint16_t)__builtin_bswap16((uint16_t)a))
#    define GUINT32_FROM_BE(a) ((uint32_t)__builtin_bswap32((uint32_t)a))
...
#    define g_return_if_fail       assert
#    define g_ascii_strcasecmp     strcasecmp
#    define g_str_has_prefix(a,b) (strstr(a,b) == a)
